...
import 'package:flutter_mycash/models/transaction_modal.dart';
import 'package:flutter_mycash/pages/models/transaction.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:hive/hive.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_mycash/controller/db_helper.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter_mycash/widget/confirm_dialog.dart';
import 'package:flutter_mycash/widget/info_snackbart.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: Ink(
                    decoration: BoxDecoration(
                      gradient:
                          LinearGradient(colors: [purpleColor, blueColor]),
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 3 ? purpleColor : Colors.white,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 3],
                style: TextStyle(
                    ...
                    color: index == 3 ? Colors.white : blueColor),
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 2 ? Colors.white : blackColor,
                ),
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 1 ? Colors.white : blackColor,
                ),
              ),
            ),
          ),
